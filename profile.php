...
if(isset($_POST['submit'])){
		...
		$target = "upload_images/".basename($_FILES['profpic']['name']);

		$conn=mysqli_connect('localhost','saurabh','test1234','images');
		...
		$sql="INSERT INTO image_table(image,roll)  VALUES('$image','$roll')";
        ...
        <div id="form">
            <h1>MY PROFILE</h1>
							...
							<?php
										...
										$sql='SELECT image,roll from image_table';
								    ...
								    mysqli_close($conn);
										...
										foreach ($users as $var) {
											if($var['roll']==$_SESSION['rollno']){
													$flag=1;
													$target = 'upload_images/'.basename($var['image']);
													echo "<div style='text-align: center'><img src=".$target .">";
													break;
											}
											//echo $var['name'];
										}
										if($flag==0){
												echo "<div style='text-align: center'><img src='img/noprofile.jpeg'>";
										}
							?>
						...
						<h3>Roll Number: <?php if(isset($_SESSION['rollno']))echo $_SESSION['rollno']; ?> </h3>
						<h3>Email: <?php if(isset($_SESSION['email']))echo $_SESSION['email']; ?> </h3>
						<h3>Year: <?php if(isset($_SESSION['year']))echo $_SESSION['year']; ?> </h3>
