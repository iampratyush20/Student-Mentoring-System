      ...
      <div class="jumbotron" style="margin-top: 100px">
        ...
        <table class="table table-striped" style="margin-top: 50px ; background-color: white">
          ...
          <tbody>
						...
						<?php
								$conn=mysqli_connect('localhost','saurabh','test1234','user_accounts');

								if(!$conn){
									echo "connection error:".mysqli_connect_error();
								}

								$sql='SELECT name,roll,email,date from users';
								...
								foreach ($users as $var) {
									// code...
									echo "<tr><td>".$var['name']."</td><td>".$var['roll']."</td><td>".$var['email']."</td><td>".$var['date']."</td></tr>";
								}
